 ...
 * Chapter 2 Section 3 Lecture
 * 
 * This is where the lecture for the third section of Chapter 2, in this program,
 * is created.
 * 
...
public class Chapter2Section3Lecture extends Lecture 
{
	public Chapter2Section3Lecture()
	{
		try 
		{
			...
			Scanner fileInputter = new Scanner(new File("Resource Files/Lecture Files/Chapter 2/Section 3 Lecture Text.txt"));
			...
			Scanner fileInputter2 = new Scanner(new File("Resource Files/Lecture Files/Chapter 2/Section 3 Lecture Text.txt"));
