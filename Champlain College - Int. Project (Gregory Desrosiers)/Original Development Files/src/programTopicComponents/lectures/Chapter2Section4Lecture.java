 ...
 * Chapter 2 Section 4 Lecture
 * 
 * This is where the lecture for the fourth section of Chapter 2, in this program,
 * is created.
 * 
...
public class Chapter2Section4Lecture extends Lecture 
{
	public Chapter2Section4Lecture()
	{
		try 
		{
			...
			Scanner fileInputter = new Scanner(new File("Resource Files/Lecture Files/Chapter 2/Section 4 Lecture Text.txt"));
			...
			Scanner fileInputter2 = new Scanner(new File("Resource Files/Lecture Files/Chapter 2/Section 4 Lecture Text.txt"));
