 ...
 * Chapter 2 Section 2 Lecture
 * 
 * This is where the lecture for the second section of Chapter 2, in this program,
 * is created.
 * 
...
public class Chapter2Section2Lecture extends Lecture 
{
	public Chapter2Section2Lecture()
	{
		try 
		{
			...
			Scanner fileInputter = new Scanner(new File("Resource Files/Lecture Files/Chapter 2/Section 2 Lecture Text.txt"));
			...
			Scanner fileInputter2 = new Scanner(new File("Resource Files/Lecture Files/Chapter 2/Section 2 Lecture Text.txt"));
