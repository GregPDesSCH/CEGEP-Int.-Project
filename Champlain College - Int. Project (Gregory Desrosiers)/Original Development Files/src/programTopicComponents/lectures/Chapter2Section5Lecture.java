 ...
 * Chapter 2 Section 5 Lecture
 * 
 * This is where the lecture for the fifth section of Chapter 2, in this program,
 * is created.
 * 
...
public class Chapter2Section5Lecture extends Lecture 
{
	public Chapter2Section5Lecture()
	{
		try 
		{
			...
			Scanner fileInputter = new Scanner(new File("Resource Files/Lecture Files/Chapter 2/Section 5 Lecture Text.txt"));
			...
			Scanner fileInputter2 = new Scanner(new File("Resource Files/Lecture Files/Chapter 2/Section 5 Lecture Text.txt"));
