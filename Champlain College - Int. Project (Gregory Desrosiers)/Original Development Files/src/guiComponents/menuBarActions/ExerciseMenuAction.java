 ...
 * Exercise Menu Action
 * 
 * Represents the abstract MenuBarAction class, only it includes the
 * appropriate listener for an ExerciseMenu object.
 * 
...
public class ExerciseMenuAction extends MenuBarAction 
{
	public ExerciseMenuAction(String name, String toolTipText, Integer mnemonicKey, KeyStroke actionKey)
	{
	...
	{
		Application.exerciseMenuListener.actionPerformed(e);
	}
}
