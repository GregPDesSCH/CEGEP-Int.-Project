 ...
 * appropriate listener for an OptionsMenu object.
 * 
...
public class OptionsMenuAction extends MenuBarAction 
{
	public OptionsMenuAction(String name, String toolTipText, Integer mnemonicKey, KeyStroke actionKey)
	{
	...
	{
		Application.optionsMenuListener.actionPerformed(e);
	}
}
