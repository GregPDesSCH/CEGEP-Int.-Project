 ...
 * Simulation Menu Action
 * 
 * Represents the abstract MenuBarAction class, only it includes the
 * appropriate listener for an SimulationMenu object.
 * 
...
public class SimulationMenuAction extends MenuBarAction 
{
	public SimulationMenuAction(String name, String toolTipText, Integer mnemonicKey, KeyStroke actionKey)
	{
	...
	{
		Application.simulationMenuListener.actionPerformed(e);
	}
}
