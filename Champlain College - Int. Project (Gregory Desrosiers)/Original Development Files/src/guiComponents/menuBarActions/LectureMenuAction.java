 ...
 * appropriate listener for a LectureMenu object.
 * 
...
public class LectureMenuAction extends MenuBarAction 
{
	public LectureMenuAction(String name, String toolTipText, Integer mnemonicKey, KeyStroke actionKey)
	{
	...
	{
		Application.lectureMenuListener.actionPerformed(e);
	}
}
